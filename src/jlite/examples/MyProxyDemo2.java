 ...
 * when MyProxy stores proxy with VOMS extensions.
 * 
 * @author Oleg Sukhoroslov
 */
public class MyProxyDemo2 {
	...
	public static void main(String[] args) {
		try {
			...
			/*
			 * ---------------------------------------------------------------------
			 * Step O. Retrieve proxy (with VOMS extensions!) from MyProxy server
			 * ---------------------------------------------------------------------
			 */
			...
			// configure grid session to use proxy retrieved from MyProxy
			config.setProxy(((GlobusGSSCredentialImpl)proxy).getGlobusCredential());
	         ...
	         * -----------------------------------------
	         */	        
	        // skipping it since we already have proxy!
